module.exports = function (middleware, options) {
    ...
    return function (req, res, next) {
        ...
        var originalCallback = function(result, redirect) {
            if (redirect) {
                files = {files: result};
        ...
        var callback = typeof options.callback !== 'function'
            ? originalCallback
            : function(result, redirect) { options.callback(result, redirect, originalCallback); }
        var handler = new UploadHandler(req, res, callback);
