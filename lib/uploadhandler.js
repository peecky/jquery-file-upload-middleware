...
module.exports = function (options) {
    ...
    UploadHandler.prototype.post = function () {
        ...
        form.onPart = function(part) {
            if (part.filename && options.fileStreamHandler) {
                counter++;
                var fileInfo = new FileInfo({ name: part.filename, size: 0, type: part.mime });
                files.push(fileInfo);
                if (!fileInfo.validateFileType() || !fileInfo.validateFilename()) {
                    // ignore uploading form data of this file
                ...
                streams.push(ps);
                options.fileStreamHandler(ps, fileInfo, files);
